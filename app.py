...
class SavingAccount(Account):
	def __init__(self):
		self.savingAccounts = {"11111" : ["hemil",1]}
                print(self.savingAccounts.keys())
                print"HI From _init_"
	...
	def authenticate(self, name, accountNumber):
		if accountNumber in self.savingAccounts.keys():
			if self.savingAccounts[self.accountNumber][0] == name:
                                print(self.savingAccounts[self.accountNumber][0])
                                print(self.savingAccounts)
...
#Consider this is the main class
print"HI From Object"
